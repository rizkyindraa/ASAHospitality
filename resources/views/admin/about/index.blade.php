                ...
                <div class="tab-content pt-2">
                    ...
                    <div class="tab-pane fade pt-3" id="picture">
                        ...
                        <form method="POST" action="{{url('update_about_foto', $about->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="profileImage" class="col-md-4 col-lg-2 col-form-label">About Image <i class="bi bi-exclamation-circle-fill" data-bs-toggle="tooltip" data-bs-placement="top" title="Recomended Resolution 1270x720"></i></label>
                                <div class="col-md-8 col-lg-10">
                                    <div class="pt-2">
